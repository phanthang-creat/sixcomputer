...
class OrderListCancelView extends StatefulWidget {
  
  const OrderListCancelView({super.key});

  @override
  State<OrderListCancelView> createState() => _OrderListCancelViewState();
}

class _OrderListCancelViewState extends State<OrderListCancelView> {
  ...
  getOrderByStatus() async {
    ...
    _orders = orders.where((element) => element.status == 'Cancel').toList();
