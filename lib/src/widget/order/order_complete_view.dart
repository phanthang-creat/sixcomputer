...
class OrderListCompletedView extends StatefulWidget {
  const OrderListCompletedView({super.key});

  @override
  State<OrderListCompletedView> createState() => _OrderListCompletedViewState();
}

class _OrderListCompletedViewState extends State<OrderListCompletedView> {
  ...
  getOrderByStatus() async {
    ...
    _orders = orders.where((element) => element.status == 'Complete').toList();
