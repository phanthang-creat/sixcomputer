...
class OrderListOnGoingView extends StatefulWidget {
  const OrderListOnGoingView({super.key});

  @override
  State<OrderListOnGoingView> createState() => _OrderListOnGoingViewState();
}

class _OrderListOnGoingViewState extends State<OrderListOnGoingView> {
  ...
  getOrderByStatus() async {
    ...
    _orders = orders.where((element) => element.status == 'Ongoing').toList();
